...
- **Features utilisées :** 18 variables liées aux bâtiments et propriétés (ex. NumberofFloors, PropertyGFATotal, GFA types, BuildingType_Nonresidential_WA, ZipCode_infrequent_sklearn, EPAPropertyType_infrequent_sklearn)
- **Encodage spécifique :**
...
- Contient :
  ...
  - La liste des noms de features (`feature_names`)
